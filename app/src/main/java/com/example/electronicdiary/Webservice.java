...
public interface Webservice {
    ...
    @PUT("modules/{id}")
    Call<Void> editModule(@Header("Authorization") String authorization, @Path("id") long id, @Body Module module);

    @PUT("events/{id}")
    Call<Void> editEvent(@Header("Authorization") String authorization, @Path("id") long id, @Body Event event);
