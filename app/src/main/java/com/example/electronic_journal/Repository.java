...
public class Repository {
    ...
    private final Webservice webservice = new Retrofit.Builder().baseUrl("http://" + ip + ":8080/api/").
            addConverterFactory(GsonConverterFactory.create(gson)).build().create(Webservice.class);
        ...
        webservice.authenticateUser(new LoginRequest(username, password)).enqueue(new Callback<JwtResponse>() {
            ...
            public void onResponse(@NotNull Call<JwtResponse> call, @NotNull Response<JwtResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    result.postValue(new Result.Error("Ошибка входа: проверьте правильность логина и пароля"));
            ...
            public void onFailure(@NotNull Call<JwtResponse> call, @NotNull Throwable t) {
                result.postValue(new Result.Error("Ошибка доступа к серверу"));
    ...
    public void getLoggedUser(JwtResponse jwtResponse, MutableLiveData<? extends Result<? extends User>> user) {
        ...
        if (jwtResponse.getRole().equals("ROLE_PROFESSOR") || jwtResponse.getRole().equals("ROLE_ADMIN")) {
        ...
        webservice.getStudentsInGroup(headerAuthorization, groupId).enqueue(new Callback<List<Student>>() {
            ...
            public void onResponse(@NotNull Call<List<Student>> call, @NotNull Response<List<Student>> response) {
                if (response.isSuccessful()) {
                    ...
                    studentsInGroup.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
        ...
        webservice.getAvailableStudents(headerAuthorization, professorId, semesterId).enqueue(new Callback<List<Student>>() {
            ...
            public void onResponse(@NotNull Call<List<Student>> call, @NotNull Response<List<Student>> response) {
                if (response.isSuccessful()) {
                    ...
                    availableStudents.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
        ...
        webservice.getAvailableSubjects(headerAuthorization, professorId, semesterId).enqueue(new Callback<List<Subject>>() {
            ...
            public void onResponse(@NotNull Call<List<Subject>> call, @NotNull Response<List<Subject>> response) {
                if (response.isSuccessful()) {
                    ...
                    availableSubjects.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
        ...
        webservice.getAvailableGroupsInSubject(headerAuthorization, professorId, semesterId, subjectId).enqueue(new Callback<List<SubjectInfo>>() {
            ...
            public void onResponse(@NotNull Call<List<SubjectInfo>> call, @NotNull Response<List<SubjectInfo>> response) {
                if (response.isSuccessful()) {
                    ...
                    availableGroupsInSubject.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
                ...
                .enqueue(new Callback<Map<String, List<SubjectInfo>>>() {
                    ...
                    public void onResponse(@NotNull Call<Map<String, List<SubjectInfo>>> call,
                        ...
                        if (response.isSuccessful()) {
                            ...
                            availableSubjectsWithGroups.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
        ...
        webservice.getAvailableStudentSubjects(headerAuthorization, studentId, semesterId).enqueue(new Callback<List<StudentPerformanceInSubject>>() {
            ...
            public void onResponse(@NotNull Call<List<StudentPerformanceInSubject>> call, @NotNull Response<List<StudentPerformanceInSubject>> response) {
                if (response.isSuccessful()) {
                    ...
                    availableStudentSubjects.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
                ...
                .enqueue(new Callback<List<StudentPerformanceInSubject>>() {
                    ...
                    public void onResponse(@NotNull Call<List<StudentPerformanceInSubject>> call, @NotNull Response<List<StudentPerformanceInSubject>> response) {
                        if (response.isSuccessful()) {
                            ...
                            studentsPerformancesInSubject.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
                ...
                .enqueue(new Callback<Map<String, StudentPerformanceInModule>>() {
                    ...
                    public void onResponse(@NotNull Call<Map<String, StudentPerformanceInModule>> call, @NotNull Response<Map<String, StudentPerformanceInModule>> response) {
                        if (response.isSuccessful()) {
                            ...
                            studentPerformanceInModules.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
                ...
                .enqueue(new Callback<Map<String, List<StudentPerformanceInModule>>>() {
                    ...
                    public void onResponse(@NotNull Call<Map<String, List<StudentPerformanceInModule>>> call,
                        ...
                        if (response.isSuccessful()) {
                            ...
                            studentsPerformancesInModules.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
                ...
                .enqueue(new Callback<Map<String, Map<String, List<StudentLesson>>>>() {
                    ...
                    public void onResponse(@NotNull Call<Map<String, Map<String, List<StudentLesson>>>> call,
                        ...
                        if (response.isSuccessful()) {
                            ...
                            studentsLessons.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
                ...
                .enqueue(new Callback<StudentPerformanceInSubject>() {
                    ...
                    public void onResponse(@NotNull Call<StudentPerformanceInSubject> call, @NotNull Response<StudentPerformanceInSubject> response) {
                        if (response.isSuccessful()) {
                            ...
                            studentPerformanceInSubject.postValue(null);
                            Log.e("ERROR_CODE", String.valueOf(response.code()));
                        }
                    }
    ...
    public void getStudentById(long studentId, MutableLiveData<Result<Student>> student) {
        webservice.getStudentById(headerAuthorization, studentId).enqueue(new Callback<Student>() {
            ...
            public void onResponse(@NotNull Call<Student> call, @NotNull Response<Student> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 401)
                        student.postValue(new Result.Error("Истек JWT токен, введите данные еще раз"));
                    else
                        student.postValue(new Result.Error("Невозможно найти данного студента"));
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
            ...
            public void onFailure(@NotNull Call<Student> call, @NotNull Throwable t) {
                student.postValue(new Result.Error("Ошибка доступа к серверу"));
                Log.e("ERROR", t.getMessage());
            }
        });
    }
        ...
        webservice.getProfessorById(headerAuthorization, professorId).enqueue(new Callback<Professor>() {
            ...
            public void onResponse(@NotNull Call<Professor> call, @NotNull Response<Professor> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 401)
                        professor.postValue(new Result.Error("Истек JWT токен, введите данные еще раз"));
                    else
                        professor.postValue(new Result.Error("Невозможно найти данного преподавателя"));
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
            ...
            public void onFailure(@NotNull Call<Professor> call, @NotNull Throwable t) {
                professor.postValue(new Result.Error("Ошибка доступа к серверу"));
                Log.e("ERROR", t.getMessage());
            }
        });
    }
    ...
    public void addStudent(Student student, MutableLiveData<Result<Boolean>> answer) {
        webservice.addStudent(headerAuthorization, student).enqueue(new Callback<Void>() {
            @Override
            public void onResponse(@NotNull Call<Void> call, @NotNull Response<Void> response) {
                if (response.isSuccessful()) {
                    answer.postValue(new Result.Success<>(true));
                } else {
                    if (response.code() == 406)
                        answer.postValue(new Result.Error("Такой логин уже существует"));
                    else
    ...
    public void addProfessor(Professor professor, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void addGroup(Group group, MutableLiveData<Result<Boolean>> answer) {
        webservice.addGroup(headerAuthorization, group).enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NotNull Call<Void> call, @NotNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 406)
                        answer.postValue(new Result.Error("Такая группа уже существует"));
                    else
                        answer.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
    ...
    public void addSubject(Subject subject, MutableLiveData<Result<Boolean>> answer) {
        webservice.addSubject(headerAuthorization, subject).enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NotNull Call<Void> call, @NotNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 406)
                        answer.postValue(new Result.Error("Такой предмет уже существует"));
                    else
                        answer.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
    ...
    public void addSemester(Semester semester, MutableLiveData<Result<Boolean>> answer) {
        webservice.addSemester(headerAuthorization, semester).enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NotNull Call<Void> call, @NotNull Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 406)
                        answer.postValue(new Result.Error("Такой учебный семестр уже существует"));
                    else
                        answer.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
    ...
    public void addEvent(Event event, MutableLiveData<Integer> answer) {
        webservice.addEvent(headerAuthorization, event).enqueue(new Callback<Integer>() {
            @Override
            public void onResponse(@NotNull Call<Integer> call, @NotNull Response<Integer> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.code() == 406) {
                        answer.postValue(Integer.valueOf(response.errorBody().source().toString().split("=")[1].split("]")[0]));
                    } else {
                        answer.postValue(-2);
                        Log.e("ERROR_CODE", String.valueOf(response.code()));
                    }
        ...
        webservice.getLastNumberOfEventType(headerAuthorization, subjectInfoId, type).enqueue(new Callback<Integer>() {
            ...
            public void onResponse(@NotNull Call<Integer> call, @NotNull Response<Integer> response) {
                if (response.isSuccessful()) {
                    ...
                    lastNumberOfEventType.postValue(null);
                    Log.e("ERROR_CODE", String.valueOf(response.code()));
                }
            }
    ...
    public void editStudent(long id, Student student, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void changeGroupInSubjectsInfo(long fromGroupId, long toGroupId, MutableLiveData<Boolean> answer) {
        webservice.changeGroupInSubjectsInfo(headerAuthorization, fromGroupId, toGroupId).enqueue(new Callback<Void>() {
            @Override
            public void onResponse(@NotNull Call<Void> call, @NotNull Response<Void> response) {
                if (response.isSuccessful()) {
                    answer.postValue(true);
    ...
    public void editProfessor(long id, Professor professor, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void editGroup(long id, Group group, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void editSubject(long id, Subject subject, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void editSemester(long id, Semester semester, MutableLiveData<Result<Boolean>> answer) {
    ...
    public void editModule(long id, Module module, MutableLiveData<Integer> answer) {
        webservice.editModule(headerAuthorization, id, module).enqueue(new Callback<Integer>() {
            @Override
            public void onResponse(@NotNull Call<Integer> call, @NotNull Response<Integer> response) {
                if (response.isSuccessful()) {
                    answer.postValue(-1);
    ...
    public void editEvent(long id, Event event, MutableLiveData<Integer> answer) {
        webservice.editEvent(headerAuthorization, id, event).enqueue(new Callback<Integer>() {
            @Override
            public void onResponse(@NotNull Call<Integer> call, @NotNull Response<Integer> response) {
                if (response.isSuccessful()) {
                    answer.postValue(-1);
